...
Feature:
  ...
  @category-0001
  Scenario: category-0001: <testCase>: Creating new categories
  ...
  @category-0002
  Scenario: category-0002: <testCase>: Error on create category with same name
    Given The Administrator wants to create category with name: '<name>'
    When The Administrator create a new category
    Then Should return Status Code <createHttpCode>
    And The response with a new category name: '<name>'
  ...
  @category-0003
  Scenario: category-0003: <testCase>: Creating and Updating categories
    Given The Administrator wants to create category with name: '<name>'
    When The Administrator create a new category
    Then Should return Status Code <createHttpCode>
    And The response with a new category name: '<name>'
  ...
  @category-0004
  Scenario: category-0004: <testCase>: Deleting non exist category
