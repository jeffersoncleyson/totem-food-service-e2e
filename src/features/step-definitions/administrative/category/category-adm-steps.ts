...
// ######### BEGIN @ID-0003
Given("The Administrator wants to update category with name: {string}", async function (name: string) {
...
// ######### BEGIN @ID-0004
Given("The Administrator wants to delete category with id: {string}", async function (id: string) {
  this.headers = { "Content-Type": "application/json" } as object;
  this.response = {
    body: {
      id: id
